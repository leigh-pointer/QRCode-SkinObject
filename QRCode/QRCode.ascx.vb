...
'<ssso:SS_QRCODE runat="server" id="sssoQRCODE" Size="150" Margin="5" />
...
Namespace SubzeroSolutions.DotNetNuke.SkinObjects
    ...
    Partial Class QRCode
        ...
        'http://chart.apis.google.com/chart?chf=a,s,000000CD|bg,lg,0,EFEFEF,0,BBBBBB,1&chs=200x200&cht=qr&chld=|10&chl=web
